...
export const SoilAnalysisIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon gradient {...props}>
    <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1"/>
    <path d="M2 17L6 13L10 17L18 9L22 13" 
          stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    <path d="M3 19H21V21H3V19Z" fill="currentColor" opacity="0.3"/>
    <circle cx="6" cy="13" r="2" fill="currentColor"/>
    <circle cx="10" cy="17" r="2" fill="currentColor"/>
    <circle cx="18" cy="9" r="2" fill="currentColor"/>
    <path d="M8 3C8 3 11 4 11 7S8 11 8 11S5 8 5 7S8 3 8 3Z" 
          fill="currentColor" opacity="0.5"/>
    <path d="M16 5C16 5 18 6 18 8S16 11 16 11S14 9 14 8S16 5 16 5Z" 
...
export const WheatIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M12 2L10 8H14L12 2Z" fill="#FFB74D"/>
    <path d="M8 6L6 12H10L8 6Z" fill="#FFB74D"/>
    <path d="M16 6L18 12H14L16 6Z" fill="#FFB74D"/>
    <path d="M4 10L2 16H6L4 10Z" fill="#FFB74D"/>
    <path d="M20 10L22 16H18L20 10Z" fill="#FFB74D"/>
    <line x1="12" y1="16" x2="12" y2="22" stroke="#8BC34A" strokeWidth="2"/>
  </CustomIcon>
);

export const RiceIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <ellipse cx="12" cy="6" rx="1.5" ry="3" fill="#F4E4B8"/>
    <ellipse cx="8" cy="8" rx="1" ry="2.5" fill="#F4E4B8"/>
    <ellipse cx="16" cy="8" rx="1" ry="2.5" fill="#F4E4B8"/>
    <ellipse cx="6" cy="10" rx="0.8" ry="2" fill="#F4E4B8"/>
    <ellipse cx="18" cy="10" rx="0.8" ry="2" fill="#F4E4B8"/>
    <line x1="12" y1="12" x2="12" y2="22" stroke="#4CAF50" strokeWidth="2"/>
  </CustomIcon>
);

export const OnionIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <ellipse cx="12" cy="14" rx="6" ry="8" fill="#E1BEE7"/>
    <ellipse cx="12" cy="14" rx="4" ry="6" fill="#CE93D8"/>
    <ellipse cx="12" cy="14" rx="2" ry="4" fill="#BA68C8"/>
    <path d="M10 6Q12 2 14 6" stroke="#4CAF50" strokeWidth="2" fill="none"/>
  </CustomIcon>
);

export const PotatoIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <ellipse cx="12" cy="12" rx="7" ry="5" fill="#DDD8B8"/>
    <circle cx="8" cy="10" r="0.5" fill="#8D6E63"/>
    <circle cx="14" cy="11" r="0.5" fill="#8D6E63"/>
    <circle cx="10" cy="14" r="0.5" fill="#8D6E63"/>
    <circle cx="16" cy="13" r="0.5" fill="#8D6E63"/>
  </CustomIcon>
);

export const TomatoIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <circle cx="12" cy="13" r="7" fill="#F44336"/>
    <path d="M8 6Q10 4 12 6Q14 4 16 6" stroke="#4CAF50" strokeWidth="2" fill="none"/>
    <circle cx="10" cy="11" r="0.5" fill="#D32F2F"/>
    <circle cx="14" cy="15" r="0.5" fill="#D32F2F"/>
  </CustomIcon>
);
...
export const MandiIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M3 12H21V20H3V12Z" fill="#FF9800"/>
    <path d="M5 4H19L21 12H3L5 4Z" fill="#FFC107"/>
    <rect x="8" y="14" width="2" height="4" fill="#795548"/>
    <rect x="14" y="14" width="2" height="4" fill="#795548"/>
    <circle cx="9" cy="8" r="1" fill="#4CAF50"/>
    <circle cx="15" cy="8" r="1" fill="#F44336"/>
  </CustomIcon>
);

export const MarketIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M2 8H22V20H2V8Z" fill="#FFC107"/>
    <path d="M4 4H20V8H4V4Z" fill="#FF9800"/>
    <rect x="6" y="10" width="3" height="8" fill="#E0E0E0"/>
    <rect x="10.5" y="10" width="3" height="8" fill="#E0E0E0"/>
    <rect x="15" y="10" width="3" height="8" fill="#E0E0E0"/>
    <circle cx="7.5" cy="6" r="0.5" fill="#4CAF50"/>
    <circle cx="12" cy="6" r="0.5" fill="#F44336"/>
    <circle cx="16.5" cy="6" r="0.5" fill="#2196F3"/>
  </CustomIcon>
);

export const PriceTagIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M12 2L22 12L12 22L2 12L12 2Z" fill="#4CAF50"/>
    <circle cx="12" cy="12" r="3" fill="#FFF"/>
    <text x="12" y="16" fontSize="3" textAnchor="middle" fill="#4CAF50" fontWeight="bold">₹</text>
  </CustomIcon>
);

export const TrendUpIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M3 17L9 11L13 15L21 7" stroke="#4CAF50" strokeWidth="3" fill="none"/>
    <path d="M16 7H21V12" stroke="#4CAF50" strokeWidth="2" fill="none"/>
  </CustomIcon>
);

export const TrendDownIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M3 7L9 13L13 9L21 17" stroke="#F44336" strokeWidth="3" fill="none"/>
    <path d="M16 17H21V12" stroke="#F44336" strokeWidth="2" fill="none"/>
  </CustomIcon>
);
...
export const WeightScaleIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    ...
    <rect x="10" y="6" width="4" height="12" fill="#9E9E9E"/>
    <circle cx="12" cy="4" r="2" fill="#607D8B"/>
    <rect x="6" y="14" width="4" height="1" fill="#FF9800"/>
    <rect x="14" y="16" width="4" height="1" fill="#FF9800"/>
  </CustomIcon>
);

export const TransportIcon: React.FC<SvgIconProps> = (props) => (
  <CustomIcon {...props}>
    <rect x="3" y="10" width="18" height="6" fill="#2196F3"/>
    <circle cx="7" cy="18" r="2" fill="#424242"/>
    <circle cx="17" cy="18" r="2" fill="#424242"/>
    <rect x="5" y="12" width="2" height="2" fill="#E3F2FD"/>
    <rect x="9" y="12" width="2" height="2" fill="#E3F2FD"/>
    <rect x="13" y="12" width="2" height="2" fill="#E3F2FD"/>
    <rect x="17" y="12" width="2" height="2" fill="#E3F2FD"/>
  </CustomIcon>
);
...
export const AppIcons = {
  ...
  // Debt Counseling & Financial Management
  DebtCounseling: DebtCounselingIcon,
  FinancialPlanning: FinancialPlanningIcon,
  Budget: BudgetIcon,
  Loan: LoanIcon,
  CreditScore: CreditScoreIcon,
  Savings: SavingsIcon,
  Investment: InvestmentIcon,
  InterestRate: InterestRateIcon,

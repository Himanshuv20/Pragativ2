            ...
            {t('home.title') && (
              <Typography 
                ...
                sx={{ 
                  ...
                  textShadow: `2px 2px 4px ${designTokens.colors.primary[200]}`,
                }}
              >
                {t('home.title')}
              </Typography>
